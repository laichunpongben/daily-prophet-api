    ...
    async def test_async_fetch(self):
        with aioresponses() as mock_responses:
            mock_responses.get(
                ...
                payload={
                    "items": [{"id": {"videoId": "KjqpLdO3_CU"}, "snippet": {"channelTitle": "GothamChess", "title": "HOW TO WIN AT CHESS!!!!!!!", "description": "Get My Chess Courses: https://www.chessly.com/ ➡️ Get my best-selling chess book: https://geni.us/gothamchess ➡️ My book ...", "publishTime": "2024-02-25T17:45:00Z"}}]
                },
                repeat=self.n,
            )
